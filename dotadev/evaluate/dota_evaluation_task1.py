...
"""
    ...
    detpath is the path for 15 result files, for the format,
    you can refer to "http://captain.whu.edu.cn/DOTAweb/tasks.html"
...
def main():
    ...
    # detpath = r'/home/dingjian/Documents/Research/experiments/light_head_faster_rotbox_best_point/Task1_results_0
    # .1_nms_epoch18/results/Task1_{:s}.txt'

    # annopath = r'/home/dingjian/code/DOTA/DOTA/media/OrientlabelTxt-utf-8/{:s}.txt'# change the directory to the
    # path of val/labelTxt, if you want to do evaluation on the valset
